...
```
$ rad patch --no-announce review --patch -U5 7a2ac7e2841cc1e7394f99f107555a499b1d3f23
╭──────────────────────╮
│ .gitignore ❲deleted❳ │
├──────────────────────┤
│ @@ -1,1 +0,0 @@      │
...
```
$ rad patch --no-announce review --patch --accept --hunk 1 7a2ac7e2841cc1e7394f99f107555a499b1d3f23
...
```
```
$ rad patch --no-announce review --patch --accept -U3 --hunk 1 7a2ac7e2841cc1e7394f99f107555a499b1d3f23
✓ Loaded existing review ([..]) for patch 7a2ac7e2841cc1e7394f99f107555a499b1d3f23
╭─────────────────────────────╮
│ MENU.txt                    │
├─────────────────────────────┤
